  ...
  return (
    <section className="pt-20">
      <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-8 px-6 lg:px-8">
        <h1 className=" font-bold text-gray-900 sm: text-4xl "> Servicios de llenado de agua LOL</h1>
        ...
        <h1 className=" font-bold text-gray-900 sm: text-4xl "> Servicios de embotellado de agua </h1>
